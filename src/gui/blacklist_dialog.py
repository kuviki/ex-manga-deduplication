...
from PyQt5.QtWidgets import (
    ...
    QPushButton, QLabel, QMessageBox, QFileDialog, QTextEdit,
    QSplitter, QGroupBox, QProgressBar, QApplication
)
...
class BlacklistDialog(QDialog):
    ...
    def init_ui(self):
        ...
        self.clear_btn.setStyleSheet("QPushButton { background-color: #ff6b6b; color: white; }")
    ...
    def create_details_panel(self):
        ...
        self.hash_label.setStyleSheet("font-family: monospace; background-color: #f5f5f5; padding: 5px;")
