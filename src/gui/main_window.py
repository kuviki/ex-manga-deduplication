...
from PyQt5.QtWidgets import (
    ...
    QGroupBox, QLabel, QPushButton, QProgressBar, QListWidget,
    QListWidgetItem, QTextEdit, QFileDialog, QMessageBox,
    QMenuBar, QMenu, QAction, QStatusBar, QTabWidget,
    QCheckBox, QSpinBox, QComboBox, QLineEdit, QFormLayout,
    QScrollArea, QFrame
)
...
class MainWindow(QMainWindow):
    ...
    def on_image_blacklisted(self, image_hash: str):
        ...
        QMessageBox.information(self, "黑名单", "图片已加入黑名单。\n建议重新扫描以更新结果。")
