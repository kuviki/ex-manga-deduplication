...
class CacheManager:
    ...
    def _get_cache_key(self, file_path: str, mtime: float, algorithm: HashAlgorithm) -> str:
        """生成缓存键
    ...
    def get_comic_cache(self, file_path: str, mtime: float, 
                       algorithm: HashAlgorithm) -> Optional[Dict[str, Any]]:
        """获取漫画文件的缓存数据
    ...
    def set_comic_cache(self, file_path: str, mtime: float, 
                       algorithm: HashAlgorithm, data: Dict[str, Any]) -> bool:
        """设置漫画文件的缓存数据
    ...
    def _validate_cache_data(self, cache_data: Dict[str, Any], 
                           file_path: str, mtime: float, 
                           algorithm: HashAlgorithm) -> bool:
        """验证缓存数据的有效性
        ...
        try:
            ...
            if 'image_count' not in data or 'image_hashes' not in data:
                return False
